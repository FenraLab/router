...
export class Server<
    ...
    TRootRouter extends Router<TRequest, TResponse, any> = Router<TRequest, TResponse, any>
> {
    ...
    public route<
        TRouter extends Endpoint<TRequest, TResponse, any> = Endpoint<TRequest, TResponse, any>
    >(
    ...
    public handle(method: string, ...handler: Middleware.TFunction<[TRequest, TResponse]>[]){
